...
import static com.example.prans.news.model.Contants.SOURCES_BUZZFEED;

/**
 * A simple {@link Fragment} subclass.
 */
public class BuzzfeedFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_BUZZFEED, API_KEY);
