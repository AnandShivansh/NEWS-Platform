...
import static com.example.prans.news.model.Contants.SOURCES_FORTUNE;

/**
 * A simple {@link Fragment} subclass.
 */
public class FortuneFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_FORTUNE, API_KEY);
