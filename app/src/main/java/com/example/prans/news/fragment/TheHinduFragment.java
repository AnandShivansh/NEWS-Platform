...
import static com.example.prans.news.model.Contants.SOURCES_THEHINDU;

/**
 * A simple {@link Fragment} subclass.
 */
public class TheHinduFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_THEHINDU, API_KEY);
