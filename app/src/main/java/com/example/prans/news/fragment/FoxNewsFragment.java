...
import static com.example.prans.news.model.Contants.SOURCES_FOXNEWS;

/**
 * A simple {@link Fragment} subclass.
 */
public class FoxNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_FOXNEWS, API_KEY);
