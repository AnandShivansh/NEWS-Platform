...
import static com.example.prans.news.model.Contants.SOURCES_AL_JAZEERA;

/**
 * A simple {@link Fragment} subclass.
 */
public class AljazeeraFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_AL_JAZEERA, API_KEY);
