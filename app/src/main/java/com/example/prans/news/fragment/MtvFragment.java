...
import static com.example.prans.news.model.Contants.SOURCES_MTV;

/**
 * A simple {@link Fragment} subclass.
 */
public class MtvFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_MTV, API_KEY);
