...
import static com.example.prans.news.model.Contants.SOURCES_BBC_NEWS;

/**
 * A simple {@link Fragment} subclass.
 */
public class BBCFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_BBC_NEWS, API_KEY);
