...
import static com.example.prans.news.model.Contants.SOURCES_GOOGLE_NEWS;

/**
 * A simple {@link Fragment} subclass.
 */
public class GoogleNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadJSON() {
        ...
        if (Internet.checkConnection(getContext())) {
            ...
            Call<NewsResource> call = request.getWorldHeadlines(SOURCES_GOOGLE_NEWS, API_KEY);
